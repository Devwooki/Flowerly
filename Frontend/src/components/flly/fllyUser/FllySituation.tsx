...
const FllySeller = () => {
  ...
  const imgList = ["/img/icon/situation01.png", "/img/icon/situation02.png", "/img/icon/situation02.png", "/img/icon/situation04.png", "/img/icon/situation05.png", "/img/icon/situation06.png", "/img/icon/situation07.png", "/img/icon/situation08.png"];
